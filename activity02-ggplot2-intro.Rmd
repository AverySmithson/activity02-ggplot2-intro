...
- `island`: noting either Biscoe, Dream, or Torgersen Islands in Palmer Archipelago
...
**Response**: First I tried the color aesthetic, and then I tried the fill aesthetic. each species of penguin in the dataset was assigned a different color for both aesthetics, except the fill aesthetic colored the whole boxplot. Also, it appears that Gentoo species has a longer flipper length than both Adelie and Chinstrap species.
...
**Response**: The boxplot is nicer to look at to get a more organized and overall idea of the distribution of the data. You can easily determine if there are outliers, and things like Q1, median, and Q3. The jitterplot is nice to look at because it shows you what points each distribution is made of, however it is much harder to determine other information and it is much more disorganized in my opinion.
