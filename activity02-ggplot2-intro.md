...
-   `species`: noting penguin species
-   `island`: noting either Biscoe, Dream, or Torgersen Islands in
    Palmer Archipelago
-   `bill_length_mm`: noting bill length in mm of penguin
-   `bill_depth_mm`: noting bill depth in mm of penguin
-   `flipper_length_mm`: noting flipper length in mm of penguin
-   `body_mass_g`: noting penguin body mass in g
-   `sex`: noting pengyin sex
-   `year`: noting year of study (2007, 2008, or 2009)
...
**Response**: First I tried the color aesthetic, and then I tried the
fill aesthetic. each species of penguin in the dataset was assigned a
different color for both aesthetics, except the fill aesthetic colored
the whole boxplot. Also, it appears that Gentoo species has a longer
flipper length than both Adelie and Chinstrap species.
...
**Response**: The boxplot is nicer to look at to get a more organized
and overall idea of the distribution of the data. You can easily
determine if there are outliers, and things like Q1, median, and Q3. The
jitterplot is nice to look at because it shows you what points each
distribution is made of, however it is much harder to determine other
information and it is much more disorganized in my opinion.
